...
export default function Event() {
  ...
  return (
    ...
    >
      ...
      {/* Floating Orbs */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-gold/20 rounded-full blur-[60px] animate-pulse" />
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-ruby/20 rounded-full blur-[80px] animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div ref={cardRef} className="relative z-10 w-full max-w-5xl px-6">
        <div className="bg-black/40 backdrop-blur-xl border border-gold/30 rounded-[3rem] p-8 md:p-16 shadow-[0_0_60px_rgba(0,0,0,0.8)] text-center relative overflow-hidden group">
          ...
          <div className="absolute -inset-[1px] rounded-[3rem] bg-gradient-to-r from-transparent via-gold/30 to-transparent opacity-50 blur-sm animate-pulse pointer-events-none" />
